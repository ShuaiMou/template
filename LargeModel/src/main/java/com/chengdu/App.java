...
public class App 
{
    public static void main(String[] args) throws Exception
    {
        ...
        String key = "zk-cb26f9a8267ec52c7cd1f437ea6edbd3";
    ...
    public static void GPTConnectorServer(String paramUrl, String paramKey) throws IOException {
        ...
        // 构建请求数据
        String requestData = "{\"model\": \"" + modelId + "\", \"messages\": [{\"role\": \"system\", \"content\": \"You are a helpful assistant.\"}, {\"role\": \"user\", \"content\": \"Translate the following English text to Chinese: 'Hello, how are you?'\"}]}";
