package com.chengdu.exchange.fanout;
...
public class FanoutConsumerB {
    ...
    public final static String EXCHANGE_NAME = "funout_exchange";//funout换器名称
    public final static String DIRECT_QUEUE = "funout_queue_b";
