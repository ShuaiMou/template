...
public class DlxConsumer {
    public final static String EXCHANGE_NAME = "dlx_topict_exchange"; //死信交换器
    public final static String DIRECT_QUEUE = "DLX_DIRECT_QUEUE";
    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        //交换器和队列绑定
        channel.queueBind(DIRECT_QUEUE, EXCHANGE_NAME, "dead_key");
        //绑定多个key
